...
public class key_surface_3 : MonoBehaviour
{
    ...
    {
        //キーを白に戻す
        //if(script.release_flag == 0 && script.key_white_flag == 1)
        //{
    ...
    {
        //if (collider.gameObject.name == "Hand_Index3_CapsuleCollider") //人差し指と接触した場合 || collider.gameObject.name == "Hand_Index3_CapsuleCollider" || collider.gameObject.name == "Hand_Index2_CapsuleCollider" || collider.gameObject.name == "Hand_Index1_CapsuleCollider"
        //{
