...
public class keyboard_surfaceL_t3 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Debug.Log("Index:OK_front");
        if (float.IsNaN(vertices[0].z))
        {
            //Debug.Log("Index 0 = " + vertices[0]);
            vertices[0].z = 0.0f;
            //Debug.Log("Index 0_fix = " + vertices[0]);
        }
        //Debug.Log("Index:OK_back");
